...
1. How to create and structure a table using what I previously learnt
2. How to styalise a table using CSS.

The black border around the names was a challenge which I ended up solving with some extra CSS.
